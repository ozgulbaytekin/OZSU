...
<div id="gallery" class="popup mfp-with-anim mfp-hide tm-bg-gray">
    ...
    <div class="tm-row tm-gallery-row">
        <div class="tm-col tm-gallery-right">
            <h2 class="tm-color-primary tm-mt-35 tm-page-title">Infirmary</h2>
            <div class="tm-gallery-right-inner">
                <table class="tm-infirmary-table">
                    <tr>
                        <td colspan="2"><div id="resultofSave" style="background-color: #71aae1;"></div></td>
                    </tr>
                    <tr>
                        <td valign="top"><div class="tm-col-6 tm-intro-col-l" id="InfirmaryFormDiv"></div></td>
                        <td valign="top"><div class="tm-col-6" id="InfirmaryTableDiv"></div></td>
                    </tr>
                </table>
            </div>
        </div>
